	...
	class pasVersions_StringTable {
		...
		function __construct() {
			...
			$this->stringArray['THANK YOU FOR INSTALLING'] = <<<'THANKYOU'
				Thank you for installing the Web Environment Plugin.<br><br>
				...
				<br>
				Therefore, before the Web Environment plugin is enabled, and made to reveal it's information, the WordPress Developer
				needs to choose how the Web Environment plugin displays it's data.&nbsp;
...
THANKYOU;
			$this->stringArray['HIDE_MENU_OPTION'] = <<<'HIDEMENU'
				<p>
					...
					If the Web Environment plugin is configured to display it's information as a Dashboard Widget, then the Dashboard Menu entry is not required.&nbsp;
					If you have chosen to display the Web Environment plugin's information as a Dashboard Widget, then you can check the box below to hide the Dashboard Menu entry.&nbsp;
